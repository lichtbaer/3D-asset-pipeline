...
def list_assets(include_deleted: bool = False) -> list[AssetMetadata]:
    """Alle Assets sortiert nach created_at desc. Ohne include_deleted werden
    soft-deleted Assets ausgelassen."""
