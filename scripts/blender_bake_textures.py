...
def run_bake(
    ...
    """
    Führt Baking für einen Typ durch. Gibt die gebackte Image zurück.
    """
    ...
    if bake_type == "roughness":
        ...
        # Blender hat keinen direkten METALLIC-Bake – wir nutzen EMIT als Workaround:
        # Metallic-Wert in Emission stecken, dann Emission baken
        # Alternativ: DIFFUSE baken wenn Metallic-Socket verbunden
        # Einfacher: ROUGHNESS mit invertiertem Metallic – nein.
        # Workaround: Bake GLOSSINESS oder nutze Custom Pass
        # Für MVP: Überspringen oder als Graustufen-DIFFUSE (Metallic als Farbe)
