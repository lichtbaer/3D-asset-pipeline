...
export const ScissorsIcon = ({ size = 20, className }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className} aria-hidden="true">
...
export const CubeIcon = ({ size = 20, className }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className} aria-hidden="true">
...
export const BoneIcon = ({ size = 20, className }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className} aria-hidden="true">
    <path d="M17 10c.7-.7 1.69-.7 2.5-.7a2.5 2.5 0 0 0 0-5c-.81 0-1.8 0-2.5-.7"/>
    <path d="M7 10c-.7-.7-1.69-.7-2.5-.7a2.5 2.5 0 0 1 0-5c.81 0 1.8 0 2.5-.7"/>
    <path d="M17 14c.7.7 1.69.7 2.5.7a2.5 2.5 0 0 1 0 5c-.81 0-1.8 0-2.5.7"/>
    <path d="M7 14c-.7.7-1.69.7-2.5.7a2.5 2.5 0 0 0 0 5c.81 0 1.8 0 2.5.7"/>
